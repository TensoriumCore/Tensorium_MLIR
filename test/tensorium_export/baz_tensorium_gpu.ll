; ModuleID = 'tensorium_export/baz_tensorium_gpu.cpp'
source_filename = "tensorium_export/baz_tensorium_gpu.cpp"
...
@.str.1 = private unnamed_addr constant [39 x i8] c"tensorium_export/baz_tensorium_gpu.cpp\00", section "llvm.metadata"
@llvm.global.annotations = appending global [1 x { ptr, ptr, ptr, i32, ptr }] [{ ptr, ptr, ptr, i32, ptr } { ptr @_Z3bazi, ptr @.str, ptr @.str.1, i32 2, ptr null }], section "llvm.metadata"
